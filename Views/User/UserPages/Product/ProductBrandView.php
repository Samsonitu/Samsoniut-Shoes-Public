        ...
        <div class="breadcrump-container text-center">
            <div class="title-section">
                <h2 style="margin-bottom: 25px;">
                    THƯƠNG HIỆU <?= htmlspecialchars($currentBrandPageInfo[0]['brandName']); ?>
                </h2>
                <ul class="breadcrump p-0">
                    ...
                    <li>
                        <a href="<?= route('ProductBrandRoute', ['brandSlug' => $currentBrandPageInfo[0]['brandSlug']]) ?>">
                            <?= htmlspecialchars($currentBrandPageInfo[0]['brandName']); ?>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <div class="container-lg">
            <div class="row">
                ...
                <div class="col-md-12 col-lg-9">
                    ...
                    <?php if(!empty($productBrandList)): ?>
                        <div class="product-list">
                            <?php foreach($productBrandList as $productBrandItem): 
                                $firstColor = reset($productBrandItem['colors']);
                            ?>
                                <div class="product-item">
                                    ...
                                    <div class="product-thumbnail">
                                        ...
                                        <?php foreach($productBrandItem['categories'] as $category) {
                                        ...
                                        ['proSlug' => htmlspecialchars($productBrandItem['proSlug'])]); ?>">
                                    ...
                                    <div class="product-info">
                                        <p class="text-center mb-0 text-secondary">
                                            <small class="product-brand" data-brand-id="<?= $productBrandItem['brandId'] ?>">
                                                <?= htmlspecialchars($productBrandItem['brandName']) ?>
                                            </small>
                                        </p>
                                        <div class="d-flex gap-2 my-2">
                                            <?php $index = 0; foreach ($productBrandItem['colors'] as $color): ?>
