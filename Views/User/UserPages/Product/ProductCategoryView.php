        ...
        <div class="breadcrump-container text-center">
            <div class="title-section">
                <h2 style="margin-bottom: 25px;">
                    DANH MỤC <?= htmlspecialchars($currentCategoryPageInfo[0]['catName']); ?>
                </h2>
                <ul class="breadcrump p-0">
                    ...
                    <li>
                        <a href="<?= route('ProductCategoryRoute', ['catSlug' => $currentCategoryPageInfo[0]['catSlug']]) ?>">
                            <?= htmlspecialchars($currentCategoryPageInfo[0]['catName']); ?>
                        </a>
                    </li>
                </ul>
            </div>
                ...
                <div class="col-md-12 col-lg-9">
                    ...
                    <?php if(!empty($productCategoryList)): ?>
                        <div class="product-list">
                            <?php foreach($productCategoryList as $productCategoryItem): 
                                $firstColor = reset($productCategoryItem['colors']);
                            ?>
                                <div class="product-item">
                                    ...
                                    <div class="product-thumbnail">
                                        ...
                                        <?php foreach($productCategoryItem['categories'] as $category) {
                                        ...
                                        ['proSlug' => htmlspecialchars($productCategoryItem['proSlug'])]); ?>">
                                    ...
                                    <div class="product-info">
                                        <p class="text-center mb-0 text-secondary">
                                            <small class="product-brand" data-brand-id="<?= $productCategoryItem['brandId'] ?>">
                                                <?= htmlspecialchars($productCategoryItem['brandName']) ?>
                                            </small>
                                        </p>
                                        <div class="d-flex gap-2 my-2">
                                            <?php $index = 0; foreach ($productCategoryItem['colors'] as $color): ?>
